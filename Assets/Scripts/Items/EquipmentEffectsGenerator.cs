...
using UnityEngine; // for Random.Range if you want to use UnityEngine's random
using Items;       // for EquipmentEffectTypes enum if it's located there
using GameplayMechanics.Effects;  // for the effect classes
